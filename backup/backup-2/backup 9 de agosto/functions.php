<?php
	...
	function lw_script_enqueuer() {
		...
		wp_register_script('customArweb',get_template_directory_uri().'/js/customArweb.js', array('jquery'), '1', true );
		wp_enqueue_script( 'customArweb' );

		wp_register_style( 'arweb', get_stylesheet_directory_uri().'/css/arweb.css', array());
        wp_enqueue_style( 'arweb' );
	}
